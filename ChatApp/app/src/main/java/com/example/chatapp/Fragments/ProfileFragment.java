...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edit_img.setOnClickListener(view12 -> {
        ...
        save.setOnClickListener(view1 -> {
            ...
            reference.child("bio").setValue(bio_et.getText().toString().trim()).addOnCompleteListener(task -> {
        ...
        image_profile.setOnClickListener(view13 -> openImage());
